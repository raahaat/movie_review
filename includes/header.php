...
<nav class="navbar navbar-inverse navbar-fixed-top" style="background-color:#840a62" role="navigation">
	<div class="container">
		<div class="navbar-header">
			...
			<a href="index.php" class=" navbar-brand"><i class="fa fa-home fa-fw"></i> STAR</a>
		</div>
			...
			<div id="navbar" class="navbar-collapse collapse">
				...
				if (empty($login)) : ?>
					<form class="navbar-form navbar-right" role="form" action="login.php" method="post">
						...
						<button type="submit" style="background-color:#db4aaf" class="btn btn-success">SIGN IN</button>
					</form>
					<ul class="nav navbar-nav">
						<li class="dropdown">
							<a href="#" class="dropdown-toggle navbar-brand" data-toggle="dropdown" role="button" aria-expanded="false"> Navigation <i class="fa fa-caret-down"></i></a>
